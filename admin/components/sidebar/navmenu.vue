    ...
    >
      ...
      >
        ...
        <label
          ...
          >{{
            parseInt(menuItem.badgeValue) > 0 ? menuItem.badgeValue : ""
          }}</label
        >
        <a
        ...
        >
          ...
          <span class="lan-3" @mouseover="setNavActiveh(menuItem, index)">
            {{ $t(menuItem.title) }}
          </span>
        ...
        >
          ...
          <i class="fa fa-angle-right pull-down" v-if="menuItem.children"></i>
        </a>

        <ul class="sidebar-submenu" v-if="menuItem.active && menuItem.children">
          <li v-for="(childrenItem, index) in menuItem.children" :key="index">
            ...
            <router-link
              class="lan-4"
              :class="{ active: childrenItem.active }"
              :to="localPath(childrenItem.path)"
  ...
  export default {
    ...
    watch: {
      ...
      width() {
        ...
        if (
          (useWindowScroll().x < 1199 &&
            this.layout.settings.layout === "Tokyo") ||
          (useWindowScroll().x < 1199 &&
            this.layout.settings.layout === "Moscow") ||
          (useWindowScroll().x < 1199 && this.layout.settings.layout === "Rome")
        ) {
