...
const getData = async () => {
  ...
  await ifetch(specialtyAPI.get, input).then((res) => {
    setInput(res);
  });
};
    ...
    swal({
      ...
      preConfirm: () => {
        return new Promise(async (resolve) => {
          await ifetch(specialtyAPI.delete, { id: id });
          iAlert().success();
          getData();
          resolve();
        });
