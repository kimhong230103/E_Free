<template>
  <div class="tab-pane fade" :class="{ 'active show': customizer == 'settings' }" id="c-pills-home">
    ...
    <ul class="sidebar-type layout-grid">
      <li data-attr="normal-sidebar" @click="customizeSidebarSetting('horizontal-wrapper', 'Seoul')">
      ...
      }" @click="customizeSidebarSetting('compact-wrapper', 'Seoul')">
        <div class="header bg-light">
          <ul>
            <li></li>
            <li></li>
...
export default {
  ...
  methods: {
    ...
    customizeColor() {
      ...
      Cookies.set("colorMode", JSON.stringify({
        primary: primary,
        secondary: secondary
      }), { expires: 365 });
